About twisted-iocpsupport-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/twisted-iocpsupport-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/twisted-iocpsupport-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add twisted-iocpsupport
# for installing globally
pixi global install twisted-iocpsupport
```
...
It is possible to list all of the versions of `twisted-iocpsupport` available on your platform:
...
```
pixi search twisted-iocpsupport --channel conda-forge
```
